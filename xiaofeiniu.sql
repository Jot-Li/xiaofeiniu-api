...
(10000,'捞派毛肚','1010.jpg',56,
'选自牛的草肚，采用流水清洗、撕片，分切等工艺，
锅开后涮10-15秒即可食用。',1),
(NULL,'精品肥牛','1011.jpg',68,
'肥牛是精选进口、自然生长谷饲100天以上的牛。
刨成薄片的牛肉。口感更细腻、化渣。',2),
(NULL,'罗非鱼','1096.jpg',39,
'经过特殊方式调理，使口感松嫩，无骨无刺，余味悠长。',3),
(NULL,'鳕鱼虾滑','1048.jpg',79,
'选择富含多种维生素深海鳕鱼，搭配海底捞独特虾滑，
健康营养，涮锅3分钟，左右即可食用。',4),
(NULL,'长生菜','1092.jpg',18,
'来自山东、云南、河北、江苏等地的新鲜长生菜、
经过挑选、清洗、口感脆嫩，涮1分钟左右即可食用。',5),
(NULL,'金针菇','1099.jpg',29,
'经过浸泡、挑选、装盘而成。口感脆嫩，久煮不化，
营养健康，锅开后再煮3分钟左右即可食用，口感爽脆。',6),
(NULL,'捞派肥猪','1063.jpg',56,
'选自牛的草肚，采用流水清洗、撕片，分切等工艺，
锅开后涮10-15秒即可食用。',1),
(NULL,'精品肥羊','1063.jpg',68,
'肥牛是精选进口、自然生长谷饲100天以上的牛。
刨成薄片的牛肉。口感更细腻、化渣。',2),
(NULL,'八爪鱼','1046.jpg',39,
'经过特殊方式调理，使口感松嫩，无骨无刺，余味悠长。',3),
(NULL,'滑嫩蟹棒','1053.jpg',79,
'选择富含多种维生素深海鳕鱼，搭配海底捞独特虾滑，
健康营养，涮锅3分钟，左右即可食用。',4),
(NULL,'茼蒿','1088.jpg',18,
'来自山东、云南、河北、江苏等地的新鲜长生菜、
经过挑选、清洗、口感脆嫩，涮1分钟左右即可食用。',5),
(NULL,'杏鲍菇','1077.jpg',29,
'经过浸泡、挑选、装盘而成。口感脆嫩，久煮不化，
营养健康，锅开后再煮3分钟左右即可食用，口感爽脆。',6),
(NULL,'捞派肥驴','1069.jpg',56,
'选自牛的草肚，采用流水清洗、撕片，分切等工艺，
锅开后涮10-15秒即可食用。',1),
(NULL,'精品肥鸡','1066.jpg',68,
'肥牛是精选进口、自然生长谷饲100天以上的牛。
刨成薄片的牛肉。口感更细腻、化渣。',2),
(NULL,'黑虎虾','1016.jpg',39,
'经过特殊方式调理，使口感松嫩，无骨无刺，余味悠长。',3),
(NULL,'鱼豆腐','1064.jpg',79,
'选择富含多种维生素深海鳕鱼，搭配海底捞独特虾滑，
健康营养，涮锅3分钟，左右即可食用。',4),
(NULL,'娃娃菜','1078.jpg',18,
'来自山东、云南、河北、江苏等地的新鲜长生菜、
经过挑选、清洗、口感脆嫩，涮1分钟左右即可食用。',5),
(NULL,'木耳','1084.jpg',29,
'经过浸泡、挑选、装盘而成。口感脆嫩，久煮不化，
